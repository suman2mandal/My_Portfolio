...
const all_certificate=()=>{
    ...
    for(let i=0;i<5;i++) {
        certificates.push(
            <SwiperSlide>
                <a className="hover:translate-y-1" href="/demo/astro-boilerplate/posts/forth-post">
            ...
            >
                ...
                <SwiperSlide>
                    ...
                    <div className="mx-auto text-white max-w-screen-lg px-3 py-10 ">
                        <div className="mx-auto max-w-screen-lg px-3 py-6">
                            ...
                            {/*    {project()}*/}
                            {/*</div>*/}
                            <EducationSlide qualification={qualification()}/>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="mx-auto max-w-screen-lg px-3 py-6">
                        ...
                        {/*    */}
                        {/*</div>*/}
                        <Certificates all_certificate={all_certificate()}/>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="mx-auto max-w-screen-lg px-3 py-6">
